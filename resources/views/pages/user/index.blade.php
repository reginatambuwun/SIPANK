  ...
  <script>
    $(function () {
      ...
      $(document).on('click', '.show-edit-modal', function () {
        ...
        let url = '{{ route('pengguna.edit', ':id') }}'; url = url.replace(':id', userId);
        // alert(userId);
      ...
      $('#editUserForm').submit(function (e) {
        ...
        let url = '{{ route('pengguna.update', ':id') }}'; url = url.replace(':id', userId);
      ...
      $('#confirmDeleteBtn').click(function (e) {
        ...
        let url = '{{ route('pengguna.destroy', ':id') }}'; url = url.replace(':id', userId);
